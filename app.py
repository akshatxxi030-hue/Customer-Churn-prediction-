...
if submit:
    ...
    def generate_actions(user_df, churn_prob):
        ...
        watch_hours = user_df["watch_hours"].iloc[0]
        monthly_fee = user_df["monthly_fee"].iloc[0]
        subscription_type = user_df["subscription_type"].iloc[0]
    ...
    # 🔹 Price sensitivity actions
        if monthly_fee > 15:
            actions.append(" Offer limited-time discount voucher")
            actions.append(" Provide loyalty-based price reduction")
    ...
    # If no actions triggered
        ...
        return actions
    actions=generate_actions(user_df, churn_prob)
